...
data_tmp4check <- aggregate(trialNum ~ PartID * com_cond * word_category, FUN=NROW, data = d )
...
d_glm_fit<-d_glm_fit %>% filter(slope_coef_t > 0)#
...
plot(multi.group, color.column = group,rawplot.ylabel = "Inflection")
```
