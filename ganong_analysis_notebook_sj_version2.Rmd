...
# wordPairType: 1=gift/dash; 2=giss/dask; 3=gith/dath
...
lsmeans(lme.slope1, list(pairwise ~ isAdult|phonemeContr), adjust = "tukey") #sig age diff for both contrasts

# SLOPE IN NEUTRAL
#no group differences except for age
...
# INFLECTION: LME
#sig group effects for children and adults in gift/dash, but not kiss/task
...
lsmeans(inflection_model_all.lme.full, list(pairwise ~ isAdult|wordPairType|phonemeContr ), adjust = "tukey")
```
